  ...
  return (
    <div className="h-14 md:h-15 w-40 md:w-60   absolute top-0 left-0 -translate-y-full overflow-hidden ">
      <motion.div
        ...
        whileTap={{ top: 0 }}
        className="shadow-[inset_0_0_10px_rgba(255,255,255,0.2)] h-14 w-30 rounded-md rounded-b-none  bg-neutral-900/60  border-t border-neutral-800  absolute left-1/2 bottom-0 -translate-x-1/2 flex flex-col gap-1 py-[6px]  text-xs select-none will-change-transform"
      >
